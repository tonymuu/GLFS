...
type Chunk struct {
	...
	TimeStampLastLeaseGrant int64    `protobuf:"varint,3,opt,name=TimeStampLastLeaseGrant,proto3" json:"TimeStampLastLeaseGrant,omitempty"`
...
func (x *Chunk) GetTimeStampLastLeaseGrant() int64 {
	if x != nil {
...
func (x *Chunk) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
var file_masterserver_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x17, 0x54, 0x69, 0x6d, 0x65,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x05, 0x5a,
